// SMR STRATEGY EXECUTION SUITE — Complete Rebuild
// Light theme | Connected state | 8 tools | Sidebar nav
...
export default function SMRSuite(){
  ...
  return <div style={{minHeight:"100vh",background:S1,display:"flex",flexDirection:"column"}}>
    ...
    <header style={{background:G,padding:"0 24px",display:"flex",justifyContent:"space-between",alignItems:"stretch",position:"sticky",top:0,zIndex:200,flexShrink:0,minHeight:58,borderBottom:`3px solid ${GOLD}`}}>
      ...
      <div style={{display:"flex",alignItems:"center"}}><div style={{...mono,fontSize:8,color:"rgba(247,244,239,0.25)",letterSpacing:"0.1em",textTransform:"uppercase"}}>Execution Suite</div></div>
    </header>
